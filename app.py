...
# 점도 슬라이더 정수/소수점 에러 수정 및 범위 100.0까지 확장
...
# 3) 최종 점성 성장률 ω (근의 공식 적용, alpha에서 omega로 변수명 변경)
